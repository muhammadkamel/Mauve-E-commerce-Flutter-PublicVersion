...
class AllReviewBtnSheet extends StatefulWidget {
  ...
  const AllReviewBtnSheet({Key? key, required this.productItem})
      : super(key: key);
...
class _AllReviewBtnSheetState extends State<AllReviewBtnSheet> {
  ...
  void initState() {
    ...
    ProductDetailsCubit.get(context)
        .getProductItemRates(productItem: widget.productItem, hasLimit: false);
  }
