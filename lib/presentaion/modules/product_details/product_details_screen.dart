...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    if (widget.productItem.size != null) {
      ProductDetailsCubit.get(context).userSelectedSize =
          widget.productItem.size![0];
    }

    if (widget.productItem.ratingValue != 0.1) {
      ProductDetailsCubit.get(context)
          .getProductItemRates(productItem: widget.productItem, hasLimit: true);
    } else {
      ProductDetailsCubit.get(context).productRateLimitedList = [];
    }
    ProductDetailsCubit.get(context).getProductSuggestedItems(
        productItem: widget.productItem, context: context);
  }
              ...
              ? BlocBuilder<ProductDetailsCubit, ProductDetailsStates>(
                  builder: (context, state) {
                    return IconButton(
                      onPressed: () {
                        ProductDetailsCubit.get(context)
                            .downloadProImageToShare(widget.productItem.image,
                                widget.productItem.name)
                            .then((file) {
                          ShareExtend.share(file.path, "image",
                              extraText: widget.productItem.name);
                        });
                      },
                      icon: const Icon(
                        Iconly_Broken.Send,
          ...
          IconButton(
            onPressed: () {
              scaffoldKey.currentState!
                  .showBottomSheet((context) => SubmitReviewSheet(
                        rateTextController: rateTextController,
                        productItem: widget.productItem,
                      ));
            },
            icon: const Icon(
              Iconly_Broken.Ticket_Star,
              color: MyColors.iconsColor,
            ),
          ),
          const CartBadgeBtn(),
      ...
      body: BlocListener<ProductDetailsCubit, ProductDetailsStates>(
        listener: (context, state) {
          ...
          if (state is SubmitUserProductRateSuccessState) {
            showToast(
                msg: 'Thank you, We will submit you review soon',
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Stack(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              child: CachedNetworkImage(
                                imageUrl: HomeLayoutCubit.get(context)
                                    .selectedCategory
                                    .image,
                                height: 38.0,
                                width: 33.0,
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              if (widget.productItem.oldPrice >
                                  widget.productItem.price)
                                AutoSizeText(
                                  '${widget.productItem.oldPrice} ' +
                                      'EGP'.tr(),
                                  style: const TextStyle(
                                    fontSize: 13.0,
                                    color: Colors.grey,
                      ...
                      widget.productItem.ratingValue != 0.1
                          ? Row(
                              ...
                              children: [
                                ...
                                Text(
                                  (widget.productItem.ratingValue /
                                          widget.productItem.ratingCount)
                                      .toStringAsFixed(1),
                                  style: const TextStyle(
                                      color: MyColors.iconsColor),
                                ),
                                ...
                                Text(
                                  '${widget.productItem.ratingCount.toInt()} Reviews',
                                  style: const TextStyle(
                                      color: MyColors.iconsColor),
                                ),
                              ],
                                                              ...
                                                              children: [
                                                                ...
                                                                FilterChip(
                                                                  label: context
                                                                      ...
                                                                      : Text(
                                                                          '${e.name_ar} +${e.price}LE',
                                                                          style:
                                                                              const TextStyle(color: MyColors.iconsColor),
                                                                        ),
                                                                  selected: ProductDetailsCubit
                                                                          .get(
                                                                              context)
                                                                      .isSelectedService(
                                                                          e),
                        ...
                        builder: (BuildContext context, state) {
                          return ConditionalBuilder(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      InkWell(
                                        child: Text(
                                            'Reviews (${widget.productItem.ratingCount.toInt()})',
                                            style: Theme.of(context)
                                                .textTheme
                                                .caption!
                                                .copyWith(
                                  ...
                                  Container(
                                    ...
                                    child: ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        return ReviewGridItem(
                                            productRateItem: ProductDetailsCubit
                                                    .get(context)
                                                .productRateLimitedList[index]);
                                      },
                                      itemCount:
                                          ProductDetailsCubit.get(context)
                                              .productRateLimitedList
                            ...
                            fallback: (BuildContext context) =>
                                state is ProductsRatesLoadingState
                    ...
                    children: [
                      ...
                      BlocBuilder<ProductDetailsCubit, ProductDetailsStates>(
                        builder: (context, state) => Row(
                          children: [
                            Text(
                              '${(widget.productItem.price + ProductDetailsCubit.get(context).userSelectedAddons.map((e) => e.price).fold(0, (_, e) => _ + e) + ProductDetailsCubit.get(context).userSelectedSize.price) /** ProductDetailsCubit.get(context).productQuantityCounter*/}',
                              style: const TextStyle(
                                fontSize: 16.0,
                                color: defaultColor,
                              ),
                    ...
                    child: ElevatedButtonIconView(
                      ...
                      function: () {
                        CartCubit.get(context).getProductInCartById(
                            productId:
                                '${widget.productItem.id}_${ProductDetailsCubit.get(context).userSelectedAddons.isNotEmpty ? ProductDetailsCubit.get(context).userSelectedAddons.map((e) => e.name).toString() : 'none'}_${widget.productItem.size != null ? ProductDetailsCubit.get(context).userSelectedSize.name : 'none'}',
                            uid: AuthCubit.get(context).userModel.uId,
                            productName: context.locale.toString() == 'en_EN'
                                ? widget.productItem.name
                                : widget.productItem.name_ar,
                            productImage: widget.productItem.image,
                            productAddon: ProductDetailsCubit.get(context)
                                    .userSelectedAddons
                                    .isNotEmpty
                                ? ProductDetailsCubit.get(context)
                                    .userSelectedAddons
                                    ...
                                    .toString()
                                : 'none',
                            productSize: widget.productItem.size != null
                                ? ProductDetailsCubit.get(context)
                                    .userSelectedSize
                                    .name
                                : 'none',
                            ...
                            quantity: ProductDetailsCubit.get(context)
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return BlocProvider(
            ...
            child: AllReviewBtnSheet(productItem: productItem));
      },
    );
  }
}
