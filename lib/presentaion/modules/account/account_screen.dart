            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment:
                        CrossAxisAlignment.start, //About,chat,contact
                    children: [
                      _userInfoCard(),
                      const SizedBox(
                        height: 12.0,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${HomeLayoutCubit.get(context).welcomeText}, ${AuthCubit.get(context).userModel.name}',
                                maxLines: 2,
                              ...
                              Text(
                                AuthCubit.get(context).userModel.phone,
                    ...
                    children: [
                      Text(
                        context.locale.toString() == 'en_EN'
                            ? HomeLayoutCubit.get(context).about
                            : HomeLayoutCubit.get(context).aboutAr,
                      ),
                      const SizedBox(
                        height: 5.0,
                      ),
  ...
  Widget _languagesCar() => InkWell(
        onTap: () {
          EasyLocalization.of(context)!
              .setLocale(context.locale.toString() == 'en_EN'
                  ? const Locale('ar', 'AR')
                  : const Locale('en', 'EN'))
              .then((_) {
