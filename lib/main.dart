  ...
  Widget build(BuildContext context) {
    ThemeData lightTheme = ThemeData(
      ...
      appBarTheme: AppBarTheme(
        titleTextStyle: TextStyle(
          ...
          fontFamily: context.locale.toString().contains('ar')
              ? 'ArabicText'
              : 'EnFont',
        ),
        titleSpacing: 19.0,
      ...
      fontFamily:
          context.locale.toString().contains('ar') ? 'ArabicText' : 'EnFont',
    );
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (_) => HomeLayoutCubit(_)
            ..initFirebaseBackgroundFCM(_)
            ..getBackgroundFcmData()
            ..getInfo()
            ..getCategoryList(),
        ),
        BlocProvider(
